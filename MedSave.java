...
public class MedSave {
    ...
    public static void main(String[] args){
        ...
        btnAdd.addActionListener(new ActionListener(){
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                row[1] = timeH.getText() + ":" + timeM.getText();
                row[2] = timeM.getText();
                row[3] = AMPM.getText();
    ...
    static void check()
    {
        ...
        String temptime1 = Integer.toString(hour) + Integer.toString(min);
